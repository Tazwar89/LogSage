...
# analysis-service's conftest.py in the same pytest run, since both define
...
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "services" / "ingestion-service"))
